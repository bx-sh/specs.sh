@spec.displays_stdout_and_stderr_if_spec_fails() {
  refute run ./spec-full.sh examples/specSpecs/basics/failing.stderrAndStdout.spec.sh
...
@spec.does_not_display_stdout_and_stderr_if_spec_passes() {
  assert run ./spec-full.sh examples/specSpecs/basics/passing.stderrAndStdout.spec.sh
