@spec.config_files_are_searched_for_and_loaded_even_before_spec_main_invoked() {
  ...
  refute run ./spec.sh examples/specSpecs/customization/overridesMain/hello.spec.sh
  ...
  assert run ./spec.sh examples/specSpecs/customization/overridesMain/hello.spec.sh
